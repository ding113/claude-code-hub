      ...
      {progressMessages.length > 0 && (
        <div className="mt-2 rounded-xl border border-white/5 bg-white/[0.02] p-3">
          ...
          <div
            ...
            className="max-h-60 overflow-y-auto rounded-lg bg-black/20 p-2 font-mono text-xs space-y-1"
          >
