        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3 mt-1 text-sm text-muted-foreground flex-wrap">
            ...
            <span className="text-xs text-muted-foreground flex-shrink-0">
              {tTimeout("summary", {
                connect: provider.connectTimeoutMs === 0 ? "∞" : ((provider.connectTimeoutMs || 5000) / 1000).toString(),
                streaming: provider.firstByteTimeoutStreamingMs === 0 ? "∞" : ((provider.firstByteTimeoutStreamingMs || 10000) / 1000).toString(),
                idle: provider.streamingIdleTimeoutMs === 0 ? "∞" : ((provider.streamingIdleTimeoutMs || 10000) / 1000).toString(),
                nonStreaming: provider.requestTimeoutNonStreamingMs === 0 ? "∞" : ((provider.requestTimeoutNonStreamingMs || 600000) / 1000).toString(),
              })}
            </span>
          </div>
        </div>
