          ...
          <div className="grid gap-4 py-4 overflow-y-auto pr-2 flex-1">
            <div className="grid gap-2">
              ...
              <Input
                ...
                className="bg-black/20 border border-white/10 rounded-lg focus:border-[#E25706]/50 focus:ring-[#E25706]/20"
                required
              />
            </div>
            ...
            <div className="grid gap-2">
              ...
              <Select value={matchType} onValueChange={(value) => setMatchType(value)}>
                <SelectTrigger className="bg-black/20 border border-white/10 rounded-lg focus:border-[#E25706]/50 focus:ring-[#E25706]/20">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
