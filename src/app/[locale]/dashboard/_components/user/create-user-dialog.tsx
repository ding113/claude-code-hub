      ...
      startTransition(async () => {
        try {
          ...
          const userRes = await createUserOnly({
            ...
            fiveHourResetMode: data.user.fiveHourResetMode,
            fiveHourResetAnchor: data.user.fiveHourResetAnchor || null,
          ...
          const keyRes = await addKey({
            ...
            fiveHourResetMode: data.key.fiveHourResetMode,
            fiveHourResetAnchor: data.key.fiveHourResetAnchor || null,
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 pt-6 pb-6 space-y-8">
          ...
          <KeyEditSection
            keyData={{
              ...
              fiveHourResetMode: currentKeyDraft.fiveHourResetMode ?? "rolling",
              fiveHourResetAnchor: currentKeyDraft.fiveHourResetAnchor ?? "",
