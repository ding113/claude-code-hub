...
const { route: removeUserRoute, handler: removeUserHandler } =
  createActionRoute("users", "removeUser", userActions.removeUser, {
    requestSchema: z.object({
      userId: z.number().int().positive(),
    }),
...
const { route: getUserLimitUsageRoute, handler: getUserLimitUsageHandler } =
  createActionRoute(
    "users",
    "getUserLimitUsage",
...
const { route: getKeyLimitUsageRoute, handler: getKeyLimitUsageHandler } =
  createActionRoute("keys", "getKeyLimitUsage", keyActions.getKeyLimitUsage, {
    requestSchema: z.object({
      keyId: z.number().int().positive(),
    }),
...
const { route: getProvidersRoute, handler: getProvidersHandler } =
  createActionRoute("providers", "getProviders", providerActions.getProviders, {
...
const { route: addProviderRoute, handler: addProviderHandler } =
  createActionRoute("providers", "addProvider", providerActions.addProvider, {
...
const { route: editProviderRoute, handler: editProviderHandler } =
  createActionRoute("providers", "editProvider", providerActions.editProvider, {
    requestSchema: z.object({
...
const { route: removeProviderRoute, handler: removeProviderHandler } =
  createActionRoute(
    "providers",
    "removeProvider",
...
const {
  route: getProvidersHealthStatusRoute,
  handler: getProvidersHealthStatusHandler,
} = createActionRoute(
  "providers",
...
const {
  route: resetProviderCircuitRoute,
  handler: resetProviderCircuitHandler,
} = createActionRoute(
  "providers",
...
const {
  route: getProviderLimitUsageRoute,
  handler: getProviderLimitUsageHandler,
} = createActionRoute(
  "providers",
...
const { route: getModelPricesRoute, handler: getModelPricesHandler } =
  createActionRoute(
    "model-prices",
    "getModelPrices",
...
const { route: uploadPriceTableRoute, handler: uploadPriceTableHandler } =
  createActionRoute(
    "model-prices",
    "uploadPriceTable",
...
const { route: syncLiteLLMPricesRoute, handler: syncLiteLLMPricesHandler } =
  createActionRoute(
    "model-prices",
    "syncLiteLLMPrices",
...
app.openapi(
  getAvailableModelsByProviderTypeRoute,
  getAvailableModelsByProviderTypeHandler,
);

const { route: hasPriceTableRoute, handler: hasPriceTableHandler } =
  createActionRoute(
    "model-prices",
    "hasPriceTable",
...
const { route: getUserStatisticsRoute, handler: getUserStatisticsHandler } =
  createActionRoute(
    "statistics",
    "getUserStatistics",
...
const { route: getUsageLogsRoute, handler: getUsageLogsHandler } =
  createActionRoute(
    "usage-logs",
    "getUsageLogs",
...
const { route: getModelListRoute, handler: getModelListHandler } =
  createActionRoute(
    "usage-logs",
    "getModelList",
...
const { route: getStatusCodeListRoute, handler: getStatusCodeListHandler } =
  createActionRoute(
    "usage-logs",
    "getStatusCodeList",
...
const { route: getOverviewDataRoute, handler: getOverviewDataHandler } =
  createActionRoute(
    "overview",
    "getOverviewData",
...
const { route: listSensitiveWordsRoute, handler: listSensitiveWordsHandler } =
  createActionRoute(
    "sensitive-words",
    "listSensitiveWords",
...
const { route: createSensitiveWordRoute, handler: createSensitiveWordHandler } =
  createActionRoute(
    "sensitive-words",
...
const { route: updateSensitiveWordRoute, handler: updateSensitiveWordHandler } =
  createActionRoute(
    "sensitive-words",
...
const { route: deleteSensitiveWordRoute, handler: deleteSensitiveWordHandler } =
  createActionRoute(
    "sensitive-words",
...
const { route: refreshCacheRoute, handler: refreshCacheHandler } =
  createActionRoute(
    "sensitive-words",
    "refreshCacheAction",
...
const { route: getCacheStatsRoute, handler: getCacheStatsHandler } =
  createActionRoute(
    "sensitive-words",
    "getCacheStats",
...
const { route: getActiveSessionsRoute, handler: getActiveSessionsHandler } =
  createActionRoute(
    "active-sessions",
    "getActiveSessions",
...
const { route: getSessionDetailsRoute, handler: getSessionDetailsHandler } =
  createActionRoute(
    "active-sessions",
    "getSessionDetails",
...
const { route: getSessionMessagesRoute, handler: getSessionMessagesHandler } =
  createActionRoute(
    "active-sessions",
    "getSessionMessages",
...
const {
  route: getNotificationSettingsRoute,
...
const {
  route: updateNotificationSettingsRoute,
...
const { route: testWebhookRoute, handler: testWebhookHandler } =
  createActionRoute(
    "notifications",
    "testWebhookAction",
