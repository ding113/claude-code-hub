...
import { modelGroupsRouter } from "../resources/model-groups/router";
import { modelLimitsRouter } from "../resources/model-limits/router";
...
import { quotaBoostsRouter } from "../resources/quota-boosts/router";
...
import { userGroupsRouter } from "../resources/user-groups/router";
...
app.route("/", modelLimitsRouter);
app.route("/", modelGroupsRouter);
app.route("/", userGroupsRouter);
app.route("/", quotaBoostsRouter);
