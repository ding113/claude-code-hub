...
function ChartTooltipContent({
  ...
  const visiblePayload = payload.filter((item: { type?: string }) => item.type !== "none");
...
function ChartLegendContent({
  ...
  const visiblePayload = payload.filter((item: LegendPayload) => item.type !== "none");
  ...
  return (
    ...
    >
      {visiblePayload.map((item: LegendPayload) => {
