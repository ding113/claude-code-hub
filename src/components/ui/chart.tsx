    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload
          ...
          .map((item: { dataKey?: string | number; name?: string; payload?: { fill?: string }; color?: string; value?: number | string }, index: number) => {
            ...
            return (
              ...
              >
                {formatter && item?.value !== undefined && item.name ? (
                  formatter(item.value, item.name, item as Parameters<typeof formatter>[2], index, payload)
                ) : (
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
