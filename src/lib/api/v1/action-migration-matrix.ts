...
export const ACTION_MIGRATION_MATRIX = [
  ...
  {
    module: "model-limit",
    sourceFile: "model-limit.ts",
    resource: "model-limits",
    endpointFamilies: ["/api/v1/model-limits"],
    access: "admin",
    exportPolicy: "all-action-exports",
  },
  {
    module: "model-group",
    sourceFile: "model-group.ts",
  ...
  {
    module: "user-group",
    sourceFile: "user-group.ts",
    resource: "user-groups",
    endpointFamilies: ["/api/v1/user-groups"],
    access: "admin",
    exportPolicy: "all-action-exports",
  },
  {
    module: "quota-boost",
    sourceFile: "quota-boost.ts",
    resource: "quota-boosts",
    endpointFamilies: ["/api/v1/quota-boosts"],
    access: "admin",
    exportPolicy: "all-action-exports",
  },
  {
