...
import type { ProviderAllowedModelRule, ProviderModelRedirectRule, ProviderType } from "@/types/provider";
...
export const providers = pgTable('providers', {
  ...
  allowedModels: jsonb('allowed_models').$type<ProviderAllowedModelRule[] | string[] | null>().default(null),
